...
## 1. Physics-informed neural networks for shock capturing in inviscid flows around an airfoil

- Date: 2026-07-09
- Category: Physics-Informed ML
- arXiv: https://arxiv.org/abs/2607.08130v1
...
## 2. Learning Turbulence Closures with Physics-Informed Neural Networks for the Rayleigh-Taylor Transition to Turbulence
...
## 3. U3DWind: A Low Altitude Wind Field Dataset and Benchmark for Urban Air Mobility

- Date: 2026-07-05
- Category: Turbulence
- arXiv: https://arxiv.org/abs/2607.04495v1
...
## 4. On the rectification of oscillatory flows by flexible leaflets in a confined geometry
...
## 5. An Innovative Computational Fluid Dynamics Discrete Dipole Approximation (CFD-DDA) Platform for Predicting Airborne Virus-in-Saliva Disinfection by Ultraviolet Irradiation
...
## 6. Strain-Rate-Consistent $\varepsilon$-Based Non-Premixed Flamelet Model
...
## 7. Generalizable turbulence closures across bluff-body shapes by PINN-based solver-agnostic training
...
## 8. Cluster-Weighted Training of Deep Surrogate Models for Subgrid Turbulent Transport
...
## 9. Manifold-adapted radial basis functions for reduced-order modelling of chaotic flows
...
## 10. Experimental evidence of Kelvin wave turbulence along a vortex core
...
## 11. Drift of interfaces in forced stably-stratified turbulence and the role of vertically-sheared helical structures
...
## 12. PhysMiner: An Agentic AI Framework for Discovering Turbulence Physics

- Date: 2026-07-04
- Category: Turbulence
- arXiv: https://arxiv.org/abs/2607.04009v1
...
## 13. Trapping-loss transition via a saddle-node bifurcation in thermophoretic particle transport driven by a time-periodic vortex
...
## 14. Three-dimensional global stability analysis of turbulent screeching jets
...
## 15. Skin friction prediction for attached flows based on two-dimensional inviscid solutions
...
## 16. Interaction of vortex rings generated by two unsynchronised drop impacts
...
## 17. An SO(3) Gauge Theory of Turbulence with Spontaneous Symmetry Breaking
...
## 18. Inverse Transfer and Coherence in Rotating Stratified Flow with Clouds and Phase Transitions
...
## 19. Tracking the boundary between absolute/convective instability using adjoint equations

- Date: 2026-07-09
- Category: Aerodynamics
- arXiv: https://arxiv.org/abs/2607.08305v1
- PDF: https://arxiv.org/pdf/2607.08305v1
- Infographic JSON: https://dutoaa.github.io/fluid-mechanics-ai-progress/infographics/2026-07-09-arxiv-tracking_the_boundary_between_absolute_convective_instability_using_adjoint_equations_infographic.json

## 20. BubbleSH: A Dataset of Rising Bubbles with Deformable Interfaces
